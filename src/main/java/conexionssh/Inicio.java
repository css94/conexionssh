...
public class Inicio {
		...
		public static void main(String[] args) throws Throwable {
			...
			/*rset = stmt.executeQuery("Select nom_patol From Patologias Where id_patol IN (Select id_patol from Patologias Where nom_patol = 'Queratocono');");
				String nombre = null;
				String descrip = null;
				String trat = null;
				String causa = null;
				...
				while (rset.next())
					
				    {
						...
						trat = rset.getString(4);
						causa = rset.getString(5);
					
						System.out.println("Sintoma  = "+nombre +" ; Descripcion: "+descrip +" ; Tratamiento: "+trat +" ; Causa: "+causa);
					 }*/
	  	    ...
	  	    while(rset.next())
	  	    {
	  	    	...
	  	    	System.out.println("Id  = "+id +" ; Sintoma: "+sintoma);
	  	    }*/
	  	      rset = stmt.executeQuery("SELECT des_sint From Sintomas Where id_sint IN (SELECT id_sint FROM Causas WHERE id_patol IN (SELECT id_patol from Patologias WHERE nom_patol = 'Queratocono'));");
				String sinto=null;
				while(rset.next())
				{
					sinto=rset.getString(1);
					System.out.println("Sintomas: "+sinto );
				}
			}
			catch(Exception e)
			{
